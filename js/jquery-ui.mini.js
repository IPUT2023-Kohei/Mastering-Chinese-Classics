...
!function(t) {
    ...
    V.escapeSelector || (F = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,
    L = function(t, e) {
    ...
    function(i) {
        ...
        this.each(function() {
            var t = V(this).attr("type")
              ...
              , e = V.data(this, "ui-" + t);
            e ? (e.option(i || {}),
            e._init && e._init()) : "button" == t ? B.call(V(this), i) : V(this).checkboxradio(V.extend({
                icon: !1
            }, i))
        })),
        n
    ...
    function q() {
        ...
        this.dpDiv = K(V("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    function K(t) {
    ...
    function U() {
        V.datepicker._isDisabledDatepicker((d.inline ? d.dpDiv.parent() : d.input)[0]) || (V(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
    ...
    V.extend(q.prototype, {
        ...
        _showDatepicker: function(t) {
            ...
            !1 === (i = (i = V.datepicker._get(n, "beforeShow")) ? i.apply(t, [t, n]) : {})) || (p(n.settings, i),
            n.lastVal = null,
    ...
    V.ui.tooltip;
    var f, g = V, m = {}, X = m.toString, $ = /^([\-+])=\s*(\d+\.?\d*)/, G = [{
    ...
    function Z(s) {
        ...
        o.length ? ("0,0,0,0" === o.join() && g.extend(o, M.transparent),
        n) : M[s]
    }
    function T(t, e, i) {
    ...
    (_.fn = g.extend(_.prototype, {
        parse: function(n, t, e, i) {
            if (void 0 === n)
                ...
                this;
            (n.jquery || n.nodeType) && (n = g(n).css(t),
            t = void 0);
            var o = this
              , s = y(n)
              , a = this._rgba = [];
            ...
            s = "array"),
            "string" === s ? this.parse(Z(n) || M._default) : "array" === s ? (b(v.rgba.props, function(t, e) {
                a[e.idx] = w(n[e.idx], e)
            }),
            this) : "object" === s ? (n instanceof _ ? b(v, function(t, e) {
                ...
                o[s] && g.inArray(null, o[s].slice(0, 3)) < 0 && (null == o[s][3] && (o[s][3] = 1),
    ...
    v.hsla.from = function(t) {
        ...
        [Math.round(255 * T(s, i, e + 1 / 3)), Math.round(255 * T(s, i, e)), Math.round(255 * T(s, i, e - 1 / 3)), t])
    }
    ,
    b(v, function(r, t) {
        var e = t.props
        ...
        b(e, function(o, a) {
            _.fn[o] || (_.fn[o] = function(t) {
                var e = y(t)
                  ...
                  , s = this[i]()
                  , n = s[a.idx];
                return "undefined" === e ? n : ("function" === e && (e = y(t = t.call(this, n))),
                null == t && a.empty ? this : ("string" === e && (e = $.exec(t)) && (t = n + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                s[a.idx] = t,
                this[i](s)))
            }
            )
    ...
    (_.hook = function(t) {
        ...
        b(t, function(t, o) {
            ...
            g.fx.step[o] = function(t) {
                t.colorInit || (t.start = _(t.elem, o),
                t.end = _(t.end),
                t.colorInit = !0),
    ...
    var tt, et, it, st, nt, ot, at, rt, lt, P, M = g.Color.names = {
        ...
        _default: "#ffffff"
    }, S = "ui-effects-", H = "ui-effects-style", z = "ui-effects-animated";
    function ht(t) {
    ...
    V.effects.animateClass = function(n, t, e, i) {
        ...
        return this.queue(function() {
            ...
            s(),
            e = e.map(function() {
                return this.end = ht(this.el[0]),
                this.diff = function(t, e) {
                    var i, s, n = {};
                    for (i in e)
                        s = e[i],
                        t[i] === s || nt[i] || !V.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s);
                    return n
                }(this.start, this.end),
                this
            }),
    ...
    V.fn.extend({
        ...
        removeClass: (et = V.fn.removeClass,
        function(t, e, i, s) {
        ...
        toggleClass: (tt = V.fn.toggleClass,
        function(t, e, i, s, n) {
    ...
    V.expr && V.expr.pseudos && V.expr.pseudos.animated && (V.expr.pseudos.animated = (ot = V.expr.pseudos.animated,
    function(t) {
    ...
    V.fn.extend({
        ...
        show: (lt = V.fn.show,
        function(t) {
            return O(t) ? lt.apply(this, arguments) : ((t = A.apply(this, arguments)).mode = "show",
            this.effect.call(this, t))
        }
        ),
        hide: (rt = V.fn.hide,
        function(t) {
            return O(t) ? rt.apply(this, arguments) : ((t = A.apply(this, arguments)).mode = "hide",
            this.effect.call(this, t))
        }
        ),
        toggle: (at = V.fn.toggle,
        function(t) {
            return O(t) || "boolean" == typeof t ? at.apply(this, arguments) : ((t = A.apply(this, arguments)).mode = "toggle",
            this.effect.call(this, t))
        }
        ),
        cssUnit: function(t) {
